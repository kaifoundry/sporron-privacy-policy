    ...
    return (
        <div className="w-full h-screen  bg-white shadow-md rounded-md overflow-hidden relative">
            <div className="h-full flex flex-col">
                ...
                <h1 className="darkfont mb-1">{privacyData.title}</h1>
                <p className="lightfont mb-4">Last updated on {privacyData.lastUpdated}</p>
                ...
                >
                    ...
                    <div className="mb-4">
                        <h2 className="title mb-2">{privacyData.clauses[0].title}</h2>
                        <p className="contentfont mb-4">{privacyData.clauses[0].content}</p>
                    </div>

                    <div className="mb-4">
                        <h2 className="title mb-2">{privacyData.clauses[1].title}</h2>
                        <p className="contentfont mb-4">{privacyData.clauses[1].content}</p>
                    </div>

                    <div className="text-sm text-gray-500 mb-2">senean leo pharetra in sit semper et. Amet quam placerat sem.</div>
                    <div className="mb-4">
                        <h2 className="title mb-2">3. {privacyData.clauses[2].title}</h2>
                        <p className="contentfont mb-4">{privacyData.clauses[2].content}</p>
                    </div>
                </div>
            </div>

                <div className="  border-gray-200 fixed bottom-0 left-0 right-0 z-10 p-4">
                {!hasScrolledToBottom ? (
                    <button
